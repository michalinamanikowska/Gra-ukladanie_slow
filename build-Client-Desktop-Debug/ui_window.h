...
public:
    ...
    {
        Window->setWindowTitle(QApplication::translate("Window", "GAME", Q_NULLPTR));
        label_2->setText(QApplication::translate("Window", "ROUND:", Q_NULLPTR));
        label->setText(QApplication::translate("Window", "SCORE:", Q_NULLPTR));
        ...
        title->setText(QApplication::translate("Window", "CREATE WORDS", Q_NULLPTR));
        pushButton_11->setText(QString());
        connectButton->setText(QApplication::translate("Window", "CONNECT", Q_NULLPTR));
        pushButton_4->setText(QString());
        result->setText(QString());
        points->setText(QString());
        startButton->setText(QApplication::translate("Window", "START", Q_NULLPTR));
